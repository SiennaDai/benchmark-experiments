...
from reporting import MIB, replication_summary, scientific_differences, summarize_run
...
def main():
    p=argparse.ArgumentParser(); p.add_argument("--runs", nargs="+", required=True); p.add_argument("--vary", nargs="*", default=[]); p.add_argument("--output", required=True); p.add_argument("--replication-json"); a=p.parse_args()
