    ...
    for seed in SEEDS:
        for update in LANDMARKS:
            ...
            for label in labels:
                ...
                stability.append({"seed": seed, "update": update, "bin_label": label, "update_cosine_gain": matched[0].get("update_cosine_gain") if matched else None, "in_global_danger_zone": label in labels})
